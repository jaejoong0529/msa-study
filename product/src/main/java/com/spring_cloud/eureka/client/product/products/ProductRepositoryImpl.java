	...
	public Page<ProductResponse> searchProducts(ProductSearchRequest searchRequest, Pageable pageable) {
		...
		QueryResults<Product> results = queryFactory
				...
				.where(
						...
						descriptionContains(searchRequest.description()),
						priceBetween(searchRequest.minPrice(), searchRequest.maxPrice()),
						quantityBetween(searchRequest.minQuantity(), searchRequest.maxQuantity())
				)
