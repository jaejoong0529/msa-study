...
public class OrderRepositoryImpl implements OrderRepositoryCustom {
	...
	@Override
	public Page<OrderResponse> searchOrders(OrderSearchRequest searchRequest, Pageable pageable, String role, String userId) {
		...
		QueryResults<Order> results = queryFactory
				...
				.where(
						...
						orderItemIdsIn(searchRequest.orderItemIds()),
		...
		List<OrderResponse> content = results.getResults().stream()
	...
	private BooleanExpression userCheck(String role, String userId) {
		return "MEMBER".equals(role) ? order.createdBy.eq(userId) : null;
	}
